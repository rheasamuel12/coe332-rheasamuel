...
# Count the amount of classes (Used ChatGPT to fix errors on this function)
...
def main():
    ...
    parser.add_argument('file', help='XML file with meteorite_landing')
    args = parser.parse_args()
    with open(args.file, 'r') as f:
        data_dict = xmltodict.parse(f.read())

    ml_data = data_dict['data']
    ...
    print("\n3.The average mass of the meteorite landings is ", compute_average_mass(ml_data['meteorite_landings'], 'mass_g'), "g")
